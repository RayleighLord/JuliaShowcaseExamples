...
<div class="nb-intro">
	<div class="header-box"> 
		<p class="nb-intro-header"> Entregable </p>
...
md"""
Este cuaderno pretende ser un pequeño ejemplo de las posibilidades que nos permiten los cuadernos interactivos de _**Pluto**_ con el lenguaje **Julia**. 
...
md"""
📝 Encuentra todos los enteros $k$ con $1 ≤ k ≤ 10000$ para los cuales se satisface en Julia que `k * (1 / k) ≠ 1`. Almacénalos en la variable `lista`.
"""
...
begin
	Base.:+(a::MyComplex, α::Real) = missing
end
...
Base.:*(a::MyComplex, b::MyComplex) = missing
